...
# ========================= CONFIG =========================
TXT_PATH = "new_tech.txt"  # ← CHANGE THIS to your .txt file name
...
# 1. Extract all text from the TXT file
print("Reading your TXT file...")
with open(TXT_PATH, "r", encoding="utf-8") as file:
    text = file.read()

print(f"TXT file has {len(text):,} characters")
...
def ask(question):
    ...
    prompt = f"""Use ONLY this context to answer the question and complete the sentences:
...
# ========================= LOOP =========================
print("\nAsk anything about your TXT file (type 'quit' to stop)\n")
while True:
    q = input("You: ").strip()
